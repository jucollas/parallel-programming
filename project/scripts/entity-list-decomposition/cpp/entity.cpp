...
Entity::Entity(int _x, int _y, int _gen, int _local_proc, int _local_food)
...
int Entity::get_local_gen() const { return local_gen; }
int Entity::get_local_proc() const { return local_proc; }
int Entity::get_local_food() const { return local_food; }

void Entity::set_local_food(int _local_food) { local_food = _local_food; }
