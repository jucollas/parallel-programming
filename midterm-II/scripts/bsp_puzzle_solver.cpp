 ...
 */
int findEmptySpace(const string& board) noexcept {
 ...
 * @return Pair (row, col)
 */
pair<int, int> index_to_cord(int index) noexcept {
 ...
 * @return Linear index
 */
int cord_to_index(const pair<int, int>& cord) noexcept {
 ...
 */
bool is_valid(const pair<int, int>& cord) noexcept {
